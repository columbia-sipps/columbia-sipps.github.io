...
# Review of regression without interactions

Let's start by revisiting regular regression without interactions. Here, we wanted to model the effects of both prestige and job type on income.
