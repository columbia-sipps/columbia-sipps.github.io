...
plot <- ggplot(high, aes(wt.c, fit)) +
  geom_point(data = df, # use original data to plot datapoints 
             aes(wt.c, mpg, color = as.factor(am.e)),#note, you must use as.factor here
...
plot + scale_color_manual(name = "AM", labels=c("Automatic", "Manual"), values = c("green", "orange"))
