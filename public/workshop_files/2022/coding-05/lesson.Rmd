...
If you looked at the help using the `?` workshop, you'll find out that the `supp` column stands for supplement type - whether the guinea pig received orange juice (OJ) or ascorbic acid (VC). You will also see that dose could be one of three doses of OJ or VC - 0.5, 1 or 2 mg/day. 
