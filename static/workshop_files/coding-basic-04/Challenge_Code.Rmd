...
subjects <- read_csv("Study2_Subjects.csv", header=TRUE, stringsAsFactors=FALSE)
...
trials <- read_csv("Study2_Trials.csv", header=TRUE, stringsAsFactors=FALSE)
...
data_Long <- data %>% 
  pivot_longer(cols = startsWith("RT"),
               names_to = "Trial",
               values_to = "RT",
               names_prefix = "RT_")
