...
```{r, eval = FALSE}
getwd()
read_csv("/Volumes/GoogleDrive/My Drive/grad-school/SIPPS/coding-basic/01_setup/shakes.csv")
...
```{r, eval = FALSE}
setwd("/Volumes/GoogleDrive/My Drive/grad-school/SIPPS/coding-basic/01_setup/")
read_csv("shakes.csv")
# replace everything except for shakes.csv with your own file path!
```
